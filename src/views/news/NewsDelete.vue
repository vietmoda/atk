<template>
  <my-dialog title="Xác nhận" width="500" 
    ...
    <template #content>
      <p>Bạn có chắc chắn xóa bài viết <br/><span class="text-warning font-weight-bold">{{ props.data?.title || `Không rõ bài viết` }}</span></p>
    </template>
    <template #action>
...
import { updateStatusNews } from '@/apis/modules/news.api';
